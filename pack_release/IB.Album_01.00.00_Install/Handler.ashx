...
public class Handler : IHttpHandler
{
    ...
    public  void  ProcessRequest(HttpContext context)
    {
        lock (_locker)
        {
            ...
            foreach (string file in context.Request.Files)
            {
                ...
                {
                    Thumbnail_url = cmb.GetWebImageOfThumb(Apcom.Common.Base.LocationImage.Album,FileNameImg),
                    Name = FileName,
    ...
    {
        string filename = cb.SaveImage(pf.InputStream,fileNameFriendly,Apcom.Common.Base.LocationImage.Album);
        var img = new Apcom.Common.Entities.CV_ImageAlbum
        {
            AlbumID = productid,
            ImageName= filename,
        };
