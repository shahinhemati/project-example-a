<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="EditProduct.ascx.cs"
    Inherits="IB.Product.EditProduct" %>
...
<div>
    <span class="cs_title">Tên sản phẩm</span><asp:TextBox runat="server" 
...
<div>
    <fieldset>
        ...
        <asp:Repeater ID="rptimgproduct" runat="server">
            <ItemTemplate>
                <img src='<%#GetWebImageOfThumb(IB.Common.Base.LocationImage.Product,Eval("FileName").ToString()) %>'
                    alt='<%#Eval("FileName") %>' />
