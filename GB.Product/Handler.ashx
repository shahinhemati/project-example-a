...
public class Handler : IHttpHandler
{
    ...
    public  void  ProcessRequest(HttpContext context)
    {
        lock (_locker)
        {
            ...
            foreach (string file in context.Request.Files)
            {
                ...
                {
                    Thumbnail_url = cmb.GetWebImageOfThumb(IB.Common.Base.LocationImage.Product,FileNameImg),
                    Name = FileName,
    ...
    {
        string filename = cb.SaveImage(pf.InputStream,fileNameFriendly,IB.Common.Base.LocationImage.Product);
        var img = new IB.Common.Entities.CV_ImageProduct
        {
            ProductID = productid,
            FileName = filename,
        };
