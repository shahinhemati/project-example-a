<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ManagerProduct.ascx.cs" Inherits="Apcom.Product.ManagerProduct" %>
<div>
...
<div>
    <div class="new_head"> 
        ...
        <div>
            <a href='<%=EditUrl("EditProduct") %>'>Thêm mới</a>
            <a href='<%=EditUrl("CatProduct") %>'>Danh mục</a>
        </div>
    </div>
    <div>
